...
- **Location**: [app/api/piper-tts/route.ts](app/api/piper-tts/route.ts)
...
**Optimization tips:**
- Reduce `num_ctx` from 16384 to 8192 or 4096 in [app/api/llm/route.ts](app/api/llm/route.ts:119)
...
Edit [app/api/llm/route.ts](app/api/llm/route.ts):
```typescript
