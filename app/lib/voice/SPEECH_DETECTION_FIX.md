...
### 1. **Improved Silence Detection** ([useVoiceInput.ts:143-148](app/lib/voice/useVoiceInput.ts#L143-L148))
...
### 2. **Faster Audio Analysis** ([useVoiceInput.ts:99](app/lib/voice/useVoiceInput.ts#L99))
...
You can adjust the thresholds in [useVoiceInput.ts](app/lib/voice/useVoiceInput.ts#L143-146):
...
- [app/lib/voice/useVoiceInput.ts](app/lib/voice/useVoiceInput.ts) - Main speech detection logic
