...
export class ContextBuilder {
  private static BASE_SYSTEM_PROMPT = `You are Hacker Reign - a helpful, knowledgeable AI coding expert.`;
...
Reasoning: ${detection.reasoning}`;
  ...
  private static resolveFinalMode(
    ...
    return (detectedMode as InteractionMode) || 'expert';
  }
 ...
 * // Output:
 * // [Context Detection]
 * //   Mode: code-review (auto-detected)
