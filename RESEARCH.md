...
**Complexity Scoring** ([app/lib/complexity/analyzer.ts](app/lib/complexity/analyzer.ts)):
```typescript
AST-based analysis:
...
**Database Schema** ([app/lib/analytics/tracker.ts:1-50](app/lib/analytics/tracker.ts#L1-L50)):
```sql
...
**State Machine** ([app/hooks/voice/useVoiceFlow.ts:1-300](app/hooks/voice/useVoiceFlow.ts#L1-L300)):
```
States:
...
**Tool Loop Protection** ([app/lib/llm/index.ts:200-250](app/lib/llm/index.ts#L200-L250)):
```typescript
const maxLoops = 5;
let loopCount = 0;
...
**From [app/lib/strategy/constraints.ts](app/lib/strategy/constraints.ts)** (comments reveal design philosophy):
